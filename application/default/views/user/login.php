<div class="container text_center">
    <div class="row">
        ...
        <div class="col-sm-6 login_div">
            <form action="<?php echo URL_BASE; ?>user/processlogin" method="POST" onsubmit="return validateForm_login()">
                <div class="form-group">
                    <div>
                        ...
                        <div>
                            ...
                            <input type="text" name="txtUser" class="form-control" id="usr" placeholder="Tên tài khoản">
                        </div>
                        <br>
                        <div>
                            <label for="pwd" class="text-primary login_center ">Mật khẩu</label>
                            <span id="pwd-alert" style="color: red"></span>
                            <input type="password" name="txtPass" class="form-control" id="pwd" placeholder="Mật khẩu"> 
                        </div>
                    </div>                   
                </div>
                <br>
